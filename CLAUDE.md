...
| `bench/cve-replay/` | Real-CVE replay corpus + runner. 157 entries (3 regression + 154 capability), all `pre:TP post:TN`; target 500. Baseline-gated via `npm run bench:cve-replay:check` (`bench/cve-replay/CONTRIBUTING.md`). |  |
